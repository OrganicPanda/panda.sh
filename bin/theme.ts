...
interface CodeTheme extends Record<string, string> {
  ...
  '--🎨-code-symbol': string
  '--🎨-code-built-in': string
}

// From highlightjs atom-one-light.css
const codeThemeLight: CodeTheme = {
  ...
  '--🎨-code-symbol': '#4078f2',
  '--🎨-code-built-in': '#c18401'
}

// From highlightjs atom-one-dark.css
const codeThemeDark: CodeTheme = {
  '--🎨-code-background': '#abb2bf',
  '--🎨-code-color': '#282c34',
  '--🎨-code-comment': '#5c6370',
  '--🎨-code-keyword': '#c678dd',
  '--🎨-code-name': '#e06c75',
...
interface StandardTheme {
  palettes: {
    base: Section4 & Section5 & Section3 & Section1 & NotCovered & CodeTheme
...
const happyHuesToStandardTheme = (
  ...
  const mergedCodeTheme: CodeTheme = {
    ...codeTheme,
...
const theme = standardThemeToCSS(
  'happyhues',
  happyHuesToStandardTheme(happyHuesTheme14, codeThemeLight),
  happyHuesToStandardTheme(happyHuesTheme4, codeThemeDark)
)
